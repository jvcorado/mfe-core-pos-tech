    ...
    const loadMicroFrontend = async () => {
      try {
        ...
        if (containerRef.current) {
          ...
          iframe.src = process.env.NEXT_PUBLIC_MF_URL_POS || "";
        ...
        console.error("Erro ao carregar micro frontend POS:", error);
        setLoading(false);
      }
    };
      ...
      <main className="w-full">
        {loading && (
          <div className="flex items-center justify-center h-64">
            ...
            <p className="ml-4 text-gray-600">Carregando aplicação POS...</p>
          </div>
        )}
